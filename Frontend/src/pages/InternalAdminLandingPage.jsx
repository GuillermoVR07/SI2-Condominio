...
import { FaBuilding, FaFileInvoiceDollar, FaBriefcase, FaTasks } from 'react-icons/fa'; // Añadimos FaTasks
...
const InternalAdminLandingPage = () => {
    const options = [
        ...
        { id: 4, title: 'Gestión de Tareas', icon: <FaTasks />, color: 'purple', path: '/tareas' }, // Nuevo
    ];
